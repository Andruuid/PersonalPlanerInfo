    ...
    return (
      <p className="text-sm text-ink-600">
        ...
        <Link href={hubPath} className="font-medium text-accent-600 hover:text-accent-700">
          Personalplanung Software in der Schweiz
        </Link>{" "}
        oder{" "}
        <a
  ...
  return (
    <aside className="rounded-xl border border-accent-600/15 bg-accent-100/50 p-5 sm:p-6">
      ...
      <p className="mt-2 text-sm leading-relaxed text-ink-700">
        Wenn Excel und WhatsApp an Grenzen stossen: Das Team hinter diesem Ratgeber
        entwickelt <strong>{siteConfig.productName}</strong> – eine Cloud-Lösung für
